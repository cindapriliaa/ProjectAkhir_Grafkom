...
def iniHandleMouse(button, state, x, y):
    global merah1, hijau1, biru1
    global merah2, hijau2, biru2
    global merah3, hijau3, biru3
    global merah4, hijau4, biru4
    if button == GLUT_RIGHT_BUTTON and state == GLUT_DOWN:
        if merah1 == 160 and hijau1 == 89 and biru1 == 201 and 55<x<165 and 491<y<610 :
            merah1 = randint (0, 255)
            hijau1 = randint (0, 255)
            biru1 = randint (0, 255)
        elif merah2 == 160 and hijau2 == 89 and biru2 == 201 and 269<x<373 and 490<y<606:
             merah2 = 252
             hijau2 = 3
             biru2 = 3
        elif merah3 == 160 and hijau3 == 89 and biru3 == 201 and 51<x<157 and 273<y<430:
             merah3 = 252
             hijau3 = 3
             biru3 = 3
        elif merah4 == 160 and hijau4 == 89 and biru4 == 201 and 266<x<370 and 279<y<379:
             merah4 = 252
             hijau4 = 3
             biru4 = 3
...
def mouseFunc(mouseX,mouseY):
    ...
    if (40<mouseX<200 and 20<mouseY<200) and check == True: #berdasarkan koordinat window
        x = mouseX + 40
        y = mouseY
