...
def iniHandleMouse(button, state, x, y):
    ...
    global merah5, hijau5, biru5
    global merah6, hijau6, biru6
    global merah7, hijau7, biru7
    global merah8, hijau8, biru8
    global merah9, hijau9, biru9
    global merah10, hijau10, biru10
    ...
    if button == GLUT_RIGHT_BUTTON and state == GLUT_DOWN:
        if merah2 == 160 and hijau2 == 89 and biru2 == 201 and 149<x<202 and 330<y<414 :
    ...
    if button == GLUT_RIGHT_BUTTON and state == GLUT_DOWN:
        if merah4 == 160 and hijau4 == 89 and biru4 == 201 and 151<x<203 and 170<y<256 :
    ...
    if button == GLUT_RIGHT_BUTTON and state == GLUT_DOWN:
        if merah7 == 160 and hijau7 == 89 and biru7 == 201 and 362<x<418 and 178<y<262 :
...
def showScreen():
    ...
    if game_over == False:
        ...
        drawText("G A M E O V E R", 280, 320)
